...
abstract class SnapHelperDelegator extends BaseSnapHelperDelegator {
  ...
  @Override int[] calculateDistanceToFinalSnap(@NonNull RecyclerView.LayoutManager layoutManager,
  ...
  @Override View findSnapView(RecyclerView.LayoutManager layoutManager) {
  ...
  @Override int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX,
      int velocityY) {
    OrientationHelper helper =
        layoutManager.canScrollHorizontally() ? OrientationHelper.createHorizontalHelper(
            layoutManager) : OrientationHelper.createVerticalHelper(layoutManager);
